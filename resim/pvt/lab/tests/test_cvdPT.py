...
class cvdPT(unittest.TestCase):

  def test_01(self):
    logger.info('\nTest #01.'
                '\nComponents: N2 C1 C2 C3 C4 C5-C6 C7-C9 C10-C15 C16+')
    PP = np_array([12240., 10720., 9180., 7640., 6120., 4650., 3110., 1680.,
                   100.]) * 1e3
    T = 13.8 + 273.15
    ...
    res = cvd(pr, PP, T, yi, flashroutine=flash.run2pPT)
    pass
  ...
  def test_02(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, dij, s0i)
    res = cvd(pr, PP, T, yi, flashroutine=flash.run2pPT, repstate=BoState)
    pass
  ...
  def test_03(self):
    ...
    res = cvd(pr, PP, T, yi, flashroutine=flash.run2pPT, repstate=RepState)
    pass

  def test_04(self):
    logger.info('\nTest #04.\nComponents: C1 C2 C3 NC4 C5+')
    PP = np_array([17120., 16360., 15820., 14940., 13850., 12670., 11490.,
  ...
  def test_05(self):
    ...
    PP = np_array([34575.1, 27680.4, 20785.6, 14580.3, 8375.1, 4927.7]) * 1e3
    T = 124.44 + 273.15
    yi = np_array([0.0001, 0.0011, 0.6963, 0.0863, 0.0534, 0.0115, 0.0233,
