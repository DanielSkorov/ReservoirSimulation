...
class TmaxSolverPTEos(Eos, Protocol):
  """A protocol for an initialized instance of a PT-based equation
  of state (PTEos) that can be used to solve cricondentherm problems.
  ...
  +---------------------+----------------------------------------------+
  | getPT_lnphii_dP_dP2 | A vector of shape `(Nc,)` of logarithms      |
  |                     | of fugacity coefficients of components and   |
...
class TmaxPTEos(TmaxSolverPTEos, State2pPTEos, Protocol):
  """A protocol for an initialized instance of a PT-based equation
  of state that can be used to calculate the cricondentherm point
...
class TmaxSolver[Eos](Protocol):
  """A protocol for callable objects that can be used to find two
  thermodynamic parameters that characterize the cricondentherm
  point (state) of a mixture.
...
class TmaxRoutine[Eos](Protocol):
  """A protocol for callable objects that can be used to find the
  cricondentherm point (state) of a mixture.
  ...
  init: tuple[float, float, Vector[Float]] | State | None
    This parameter is used to initialize a cricondentherm state
