...
class psat(unittest.TestCase):
  ...
  def test_01(self):
    ...
    Psat = PsatPT(pr, method='ss', improve_P0=True, stabgrid=False,
  ...
  def test_03(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
    Psat = PsatPT(pr, method='newton', improve_P0=True, stabgrid=False,
  ...
  def test_04(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
    Psat = PsatPT(pr, method='newton-b', improve_P0=True, stabgrid=False,
                  stabkwargs=dict(method='qnss'), maxiter=5)
    res = Psat.run(T, yi, P0=P0, Npoint=10)
    self.assertTrue(res.success)
    pass
  ...
  def test_05(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
    Psat = PsatPT(pr, method='newton-c', improve_P0=True, stabgrid=False,
  ...
  def test_06(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
    Psat = PsatPT(pr, method='ss', improve_P0=True, stabgrid=True,
                  stabkwargs=dict(method='qnss'), maxiter=125)
    res = Psat.run(T, yi, P0=P0, Npoint=10)
    self.assertTrue(res.success)
    pass
  ...
  def test_08(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
    Psat = PsatPT(pr, method='newton', improve_P0=True, stabgrid=True,
                  stabkwargs=dict(method='qnss'), maxiter=8)
    res = Psat.run(T, yi, P0=P0, Npoint=10)
    self.assertTrue(res.success)
    pass
  ...
  def test_09(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
    Psat = PsatPT(pr, method='newton-b', improve_P0=True, stabgrid=True,
                  stabkwargs=dict(method='qnss'), maxiter=8)
    res = Psat.run(T, yi, P0=P0, Npoint=10)
    self.assertTrue(res.success)
    pass
  ...
  def test_10(self):
    ...
    pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
    Psat = PsatPT(pr, method='newton-c', improve_P0=True, stabgrid=True,
                  stabkwargs=dict(method='qnss'), maxiter=10)
    res = Psat.run(T, yi, P0=P0, Npoint=10)
    self.assertTrue(res.success)
    pass
