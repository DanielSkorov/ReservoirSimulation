...
#     env = env2pPT(pr, stabkwargs=dict(method='qnss'), maxiter=6)
#     res = env.run(P0, T0, yi, 0., maxpoints=360)
...
#     res = env.run(P0, T0, yi, 0., improve_P0=True, sidx0=4, maxpoints=400,
#                   maxstep=0.025)
#     self.assertTrue(res.success)
#     if plotting:
...
#     ])
#     pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
#     env = env2pPT(pr, Tmin=193.15, stabkwargs=dict(method='qnss'), maxiter=7)
#     res = env.run(P0, T0, yi, 0., improve_P0=True, maxpoints=432)
#     self.assertTrue(res.success)
#     if plotting:
#       self.plot(res, -80., 10., 0., 30.)
#     pass
...
#     res = env.run(P0, T0, yi, 0., improve_P0=True, sidx0=5, maxpoints=1, maxstep=0.05)
#     self.assertTrue(res.success)
#     if plotting:
...
#     ])
#     pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
#     env = env2pPT(pr, Tmin=295.6, stabkwargs=dict(method='qnss'), maxiter=12)
#     res = env.run(P0, T0, yi, 0., improve_P0=True, sidx0=2, maxpoints=213)
#     self.assertTrue(res.success)
#     if plotting:
...
#     ])
#     pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
#     env = env2pPT(pr, Tmin=328.15, stabkwargs=dict(method='qnss'), maxiter=12,
#                   tol=1e-10)
#     res = env.run(P0, T0, yi, 0., improve_P0=True, sidx0=0, maxpoints=195)
#     self.assertTrue(res.success)
#     if plotting:
#       self.plot(res, 0., 500., 0., 100.)
#     pass
...
#     ])
#     pr = pr78(Pci, Tci, wi, mwi, vsi, dij)
#     env = env2pPT(pr, Tmin=313.15, stabkwargs=dict(method='qnss'), maxiter=20)
#     res = env.run(P0, T0, yi, 0., improve_P0=True, sidx0=-2)
#     self.assertTrue(res.success)
#     if plotting:
#       self.plot(res, 0., 500., 0., 100.)
#     pass
