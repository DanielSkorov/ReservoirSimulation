...
````{div} full-width
Рассмотрим нахождение частных производных логарифма коэффициента летучести (и логарифма летучести) по давлению, объему, температуре и количеству вещества компонента компонента с использованием [уравнений состояния Суаве-Редлиха-Квонга и Пенга-Робинсона](EOS-2-SRK-PR.md#pvt-eos-srkpr).
````

<a id='pvt-eos-appendix-fugacitypd-srkpr-p'></a>
````{div} full-width
Логарифм коэффициента летучести $i$-го компонента с использованием уравнений состояния Суаве-Редлиха-Квонга и Пенга-Робинсона, [записанный](EOS-2-SRK-PR.md#pvt-eos-srkpr-fugacitycoeff-pt) относительно давления $P$, температуры $T$ и коэффициента сверхсжимаемости $Z$:
...
Здесь и далее принимается, что параметры $\alpha_m$ и $b_m$ рассчитываются с использованием [правил смешивания Ван-дер-Ваальса](EOS-2-SRK-PR.md#pvt-eos-srkpr-mixrules).
...
Также необходимо получить частные производные коэффициентов попарного взаимодействия по температуре при использовании [GCM](EOS-Appendix-B-BIP.md#pvt-eos-appendix-bip-gcm) для их расчета:
...
Частные производные параметров $\alpha_m$ и $b_m$ по количеству вещества $k$-го компонента были рассмотрены [ранее](EOS-1-VanDerWaals.md#pvt-eos-vdw-ambmderivative). Поэтому здесь приведем только конечные выражения:
...
Также необходимо получить вторые частные производные коэффициентов попарного взаимодействия по температуре при использовании [GCM](EOS-Appendix-B-BIP.md#pvt-eos-appendix-bip-gcm) для их расчета:
