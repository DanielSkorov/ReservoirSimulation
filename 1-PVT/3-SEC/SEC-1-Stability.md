...
Пусть $Y_i = y_i \mathrm{e}^{-\bar{K}}$, тогда условие стационарности функции TPD:
...
можно использовать метод Ньютона.
