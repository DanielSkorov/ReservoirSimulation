...
В данном разделе будет использоваться второй подход. При его использовании локализация насыщенного состояния будет определяться двумя факторами: направлением поиска и стабильностью однофазного состояния для начального приближения.
