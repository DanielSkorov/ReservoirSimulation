...
$$ \begin{align}
& g_i = \ln k_i + \ln \varphi_i \left( \mathbf{y} \right) - \ln \varphi_i \left( \mathbf{z} \right) = 0, \; i = 1 \, \ldots \, N_c, \\
& \bar{D} = \sum_{i=1}^{N_c} y_i \left( \ln y_i + \ln \varphi_i \left( \mathbf{y} \right) - \ln \varphi_i \left( \mathbf{z} \right) - \ln z_i \right) = 0,
\end{align} $$
...
Подробнее остановимся на решении уравнения, выражающее условие нахождения рассматриваемой системы на границе двухфазной области.
