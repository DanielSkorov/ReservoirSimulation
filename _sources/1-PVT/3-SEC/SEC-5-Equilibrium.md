...
Данный раздел, был посвящен нахождению равновесного состояния для различных формулировок. В следующем разделе будут рассмотрены различные пределы *(limit locus)*, характерные для методологий расчета равновесного состояния и проверки стабильности, в том числе речь пойдет про нахождение геометрического места точек насыщения (конденсации), являющихся одной их предельных областей, характеризующейся физичными значениями мольных долей фаз.
