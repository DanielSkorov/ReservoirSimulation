...
На границе раздела могут скачкообразно меняться какие-либо [термодинамические параметры](../0-TD/TD-1-Basics.md#pvt-td-basics-observables) фаз, например, плотность, компонентный состав, вязкость или даже давление. Рассмотренные в рамках [предыдущего раздела](../1-EOS/EOS-0-Introduction.md) уравнения состояния могут быть использованы для определения соотношений между параметрами фаз. Кроме того, необходимо напомнить, что термодинамические параметры макроскопических систем (фаз), строго говоря, относятся только к равновесным состояниям. Таким образом, настоящий раздел посвящен рассмотрению вопросов определения термодинамических параметров в равновесном состоянии и самого равновесного состояния системы с использованием уравнений состояния.
