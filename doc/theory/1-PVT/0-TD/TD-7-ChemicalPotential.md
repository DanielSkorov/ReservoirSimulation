...
Дополним дифференциал энтропии, используемый при выводе [уравнения Гиббса](TD-6-Entropy.md#pvt-td-entropy-thermodynamicidentity), следующим образом:
...
Если в системе имеется несколько видов молекул (несколько компонентов), тогда выражение для [уравнения Гиббса](TD-6-Entropy.md#pvt-td-entropy-thermodynamicidentity) будет записываться следующим образом:
